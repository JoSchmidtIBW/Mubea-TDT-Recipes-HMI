        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            ...
            window.setTimeout(function () {
              location.assign("".concat(strPathApiV1, "/createRecipeOverview"));
            }, 1500);
          }
          _context.next = 13;
          break;
...
exports.showRecipesTDToverviewTable = exports.default = exports.createRecipe2_St_2_BSB = exports.convertOldRecipes = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts.js");
var _process = _interopRequireDefault(require("process"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var createRecipe2_St_2_BSB = exports.createRecipe2_St_2_BSB = /*#__PURE__*/function () {
  ...
  return function createRecipe2_St_2_BSB(_x) {
    return _ref.apply(this, arguments);
  };
}();
var convertOldRecipes = exports.convertOldRecipes = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(importOldRecipes) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
  ...
  return function convertOldRecipes(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
          ...
          if (res.data && res.data.status === 'success') {
            ...
            $(document).ready(function () {
              $('#recipesTDToverviewTable tbody').on('click', 'tr', function () {
                ...
                var dynamicContent = generateDynamicContent(rowData);
        ...
        case 9:
          ...
          console.error('Error in showRecipesTDToverviewTable:', _context3.t0);
...
function drawXAxis(ctx, eckenListe, standartWerte, padding, scaleY, minX, minY) {
  ...
  var yPosXXX = ctx.canvas.height - padding + 0.2 / scaleY + 0; // gleiche yPos wie in Ihrer vorherigen Funktion
...
function drawScaleX(ctx, eckenListe, standartWerte) {
  ...
  var yPos = ctx.canvas.height - padding + 0.2 / scaleY + 0; // Hier können Sie den Wert anpassen
...
exports.updateUser = exports.showUsers = exports.deleteUser = exports.createNewUser = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts.js");
var _process = _interopRequireDefault(require("process"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var createNewUser = exports.createNewUser = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(employeeNumber, firstname, lastname, birthDate, gender, language, professional, email, password, passwordConfirm, role, department) {
    var res;
  ...
  return function createNewUser(_x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15) {
...
if (newUserDataForm) {
  newUserDataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var employeeNumber, firstname, lastname, birthDate, gender, language, professional, email, password, passwordConfirm, role, selectedDepartments, department;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            ...
            (0, _user.createNewUser)(employeeNumber, firstname, lastname, birthDate, gender, language, professional, email, password, passwordConfirm, role, department);
          case 29:
          case "end":
            return _context2.stop();
        }
...
var recipeSendStatus = document.getElementById('recipeSendStatus');
if (recipeSendForm) {
  recipeSendButton.addEventListener('click', function (e) {
    console.log('Bin recipeSendForm');
    e.preventDefault();
    var recipeSendDataInput = document.getElementById('recipeToSendRowdataInput');
    var recipeSendData = recipeSendDataInput.value;
    console.log('recipeSendData:', recipeSendData);
    console.log('JSON.parse(recipeSendData):', JSON.parse(recipeSendData));
    var recipeSendDataJSON = JSON.parse(recipeSendData);
    if (recipeSendData.trim() !== '') {
      //console.log('recipeSendData:', recipeSendData);
      //console.log('JSON.parse(recipeSendData):', JSON.parse(recipeSendData));
      recipeSendStatus.textContent = "Rezept gesendet: ".concat(recipeSendDataJSON.artikelNummer, " ").concat(recipeSendDataJSON.artikelName);
    } else {
...
if (createRecipe2_St_2_BSB_DataForm) {
  createRecipe2_St_2_BSB_DataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var artikelNummer, artikelName, ziehGeschwindigkeit, benutzerVorName, benutzerNachName, rohrAussenDurchmesserLetzterZug, rohrWandDickeAussenDurchmesserLetzterZug, rohrInnenDurchmesserLetzterZugBerechnet, rohrAussenDurchmesserTDTZug, angel, dornDurchmesserErsteStufe, dornPositionErsteStufe, dornDurchmesserZweiteStufe, dornPositionZweiteStufe, fixlaenge, ausgleichstueck, mehrfachlaenge, anzahlFixlaengenProMehrfachlaenge, mindestGutanteil, profileGekoppelt, obereToleranz, untereToleranz, wanddickeEcke0, positionEcke0, wanddickeEcke1, positionEcke1, wanddickeEcke2, positionEcke2, wanddickeEcke3, positionEcke3, wanddickeEcke3Zwischen4, positionEcke3Zwischen4, wanddickeEcke4, positionEcke4, wanddickeEckeEnde, positionEckeEnde, benutzerID, data;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            rohrAussenDurchmesserLetzterZug = document.getElementById('rohrAussenDurchmesserLetzterZug').value;
            rohrWandDickeAussenDurchmesserLetzterZug = document.getElementById('rohrWandDickeAussenDurchmesserLetzterZug').value;
            rohrInnenDurchmesserLetzterZugBerechnet = document.getElementById('rohrInnenDurchmesserLetzterZugBerechnet').value;
            rohrAussenDurchmesserTDTZug = document.getElementById('rohrAussenDurchmesserTDTZug').value;
            angel = document.getElementById('angel').value;
            dornDurchmesserErsteStufe = document.getElementById('dornDurchmesserErsteStufe').value;
            dornPositionErsteStufe = document.getElementById('dornPositionErsteStufe').value;
            dornDurchmesserZweiteStufe = document.getElementById('dornDurchmesserZweiteStufe').value;
            dornPositionZweiteStufe = document.getElementById('dornPositionZweiteStufe').value;
            fixlaenge = document.getElementById('fixlaenge').value;
            ausgleichstueck = document.getElementById('ausgleichstueck').value;
            mehrfachlaenge = document.getElementById('mehrfachlaenge').value;
            anzahlFixlaengenProMehrfachlaenge = document.getElementById('anzahlFixlaengenProMehrfachlaenge').value;
            mindestGutanteil = document.getElementById('mindestGutanteil').value;
            profileGekoppelt = document.getElementById('profileGekoppelt').value;
            obereToleranz = document.getElementById('obereToleranz').value;
            untereToleranz = document.getElementById('untereToleranz').value;
            wanddickeEcke0 = document.getElementById('wanddickeEcke0').value;
            positionEcke0 = document.getElementById('positionEcke0').value;
            wanddickeEcke1 = document.getElementById('wanddickeEcke1').value;
            positionEcke1 = document.getElementById('positionEcke1').value;
            wanddickeEcke2 = document.getElementById('wanddickeEcke2').value;
            positionEcke2 = document.getElementById('positionEcke2').value;
            wanddickeEcke3 = document.getElementById('wanddickeEcke3').value;
            positionEcke3 = document.getElementById('positionEcke3').value;
            wanddickeEcke3Zwischen4 = document.getElementById('wanddickeEcke3Zwischen4').value;
            positionEcke3Zwischen4 = document.getElementById('positionEcke3Zwischen4').value;
            wanddickeEcke4 = document.getElementById('wanddickeEcke4').value;
            positionEcke4 = document.getElementById('positionEcke4').value;
            wanddickeEckeEnde = document.getElementById('wanddickeEckeEnde').value;
            positionEckeEnde = document.getElementById('positionEckeEnde').value;
            benutzerID = document.getElementById('benutzerID').value; // console.log('artikelNummer: ' + artikelNummer);
            // console.log('artikelName: ' + artikelName);
            data = {
              artikelNummer: artikelNummer,
              artikelName: artikelName,
              ziehGeschwindigkeit: ziehGeschwindigkeit,
              benutzerVorName: benutzerVorName,
              benutzerNachName: benutzerNachName,
              benutzerID: benutzerID,
              rohrAussenDurchmesserLetzterZug: rohrAussenDurchmesserLetzterZug,
              rohrWandDickeAussenDurchmesserLetzterZug: rohrWandDickeAussenDurchmesserLetzterZug,
              rohrInnenDurchmesserLetzterZugBerechnet: rohrInnenDurchmesserLetzterZugBerechnet,
              rohrAussenDurchmesserTDTZug: rohrAussenDurchmesserTDTZug,
              angel: angel,
              dornDurchmesserErsteStufe: dornDurchmesserErsteStufe,
              dornPositionErsteStufe: dornPositionErsteStufe,
              dornDurchmesserZweiteStufe: dornDurchmesserZweiteStufe,
              dornPositionZweiteStufe: dornPositionZweiteStufe,
              fixlaenge: fixlaenge,
              ausgleichstueck: ausgleichstueck,
              mehrfachlaenge: mehrfachlaenge,
              anzahlFixlaengenProMehrfachlaenge: anzahlFixlaengenProMehrfachlaenge,
              mindestGutanteil: mindestGutanteil,
              profileGekoppelt: profileGekoppelt,
              obereToleranz: obereToleranz,
              untereToleranz: untereToleranz,
              wanddickeEcke0: wanddickeEcke0,
              positionEcke0: positionEcke0,
              wanddickeEcke1: wanddickeEcke1,
              positionEcke1: positionEcke1,
              wanddickeEcke2: wanddickeEcke2,
              positionEcke2: positionEcke2,
              wanddickeEcke3: wanddickeEcke3,
              positionEcke3: positionEcke3,
              wanddickeEcke3Zwischen4: wanddickeEcke3Zwischen4,
              positionEcke3Zwischen4: positionEcke3Zwischen4,
              wanddickeEcke4: wanddickeEcke4,
              positionEcke4: positionEcke4,
              wanddickeEckeEnde: wanddickeEckeEnde,
              positionEckeEnde: positionEckeEnde
            };
            (0, _recipes.createRecipe2_St_2_BSB)(data);
          case 41:
          case "end":
            return _context3.stop();
        }
